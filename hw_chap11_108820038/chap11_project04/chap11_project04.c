...
void analyze_hand(int rankNum[], int suitNum[], int *straight, int *flush, int *four, int *three, int *pair) {
...
void print_result(int *straight, int *flush, int *four, int *three, int *pair) {
...
int main(void) {
    ...
    while (1) {
        ...
        analyze_hand(num_in_rank, num_in_suit, &straight, &flush, &four, &three, &pair);
